...
<body data-bs-spy="scroll" data-bs-target="#navbarMenu" data-bs-offset="0">
  ...
  <header class="navbar navbar-expand-md navbar-dark fixed-top">
    ...
    <div class="container-xl">
      ...
      <!-- 會員登入、購物車的介面 -->
          <!-- <div>
            <ul class="navbar-nav ms-auto mb-2 md-5 text-center">
              <li class="nav-item-1 ms-auto">
                <a class="nav-link1" href="#">
                  <img src="../images/Function_images/profile.png" width="40" height="auto" alt="User Icon">
                </a>
              </li>
              <li class="nav-item-1 ms-auto">
                <a class="nav-link1" href="#">
                  <img src="../images/Function_images/shopping-cart.png" width="40" height="auto" alt="Shopping cart Icon">
                </a>
              </li>
            </ul>
          </div> -->
